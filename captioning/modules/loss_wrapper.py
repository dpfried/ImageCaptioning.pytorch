...
class LossWrapper(torch.nn.Module):
    ...
    def forward(self, fc_feats, att_feats, labels, masks, att_masks, gts, gt_indices,
                sc_flag, struc_flag, contrastive_type=None, ids=None):
        opt = self.opt
        ...
        if struc_flag:
        ...
        elif contrastive_type in ['incremental', 'global']:
            ...
            if contrastive_type == 'incremental':
                ...
                raise NotImplementedError(f"contrastive_type {contrastive_type}")
        elif not sc_flag:
